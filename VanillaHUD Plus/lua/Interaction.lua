if string.lower(RequiredScript) == "lib/units/beings/player/states/playerstandard" then
	...
	function PlayerStandard:_start_action_reload(t, ...)
		...
		if PlayerStandard.SHOW_RELOAD and not hide_int_state[managers.player:current_state()] and not (PDTHHud and PDTHHud.Options:GetValue("HUD/Interaction")) then
	...
	function PlayerStandard:_update_reload_timers(t, ...)
		...
		if PlayerStandard.SHOW_RELOAD and not (PDTHHud and PDTHHud.Options:GetValue("HUD/Interaction")) then
	...
	function PlayerStandard:_interupt_action_reload(...)
		...
		if self._state_data.show_reload and PlayerStandard.SHOW_RELOAD and not (PDTHHud and PDTHHud.Options:GetValue("HUD/Interaction")) then
			managers.hud:hide_interaction_bar(false)
			self._state_data.show_reload = false
		end
		return val
	...
	function PlayerStandard:_start_action_melee(t, input, instant, ...)
		...
		if not instant then
			...
			if PlayerStandard.SHOW_MELEE and self._state_data.meleeing and not hide_int_state[managers.player:current_state()] and not (PDTHHud and PDTHHud.Options:GetValue("HUD/Interaction")) then
	...
	function PlayerStandard:_update_melee_timers(t, ...)
		...
		if PlayerStandard.SHOW_MELEE and self._state_data.meleeing and self._state_data.show_melee and not (PDTHHud and PDTHHud.Options:GetValue("HUD/Interaction")) then
...
elseif string.lower(RequiredScript) == "lib/managers/hud/hudinteraction" then
	...
	function HUDInteraction:show_interaction_bar(current, total)
		...
		HUDInteraction.SHOW_TIME_REMAINING = VHUDPlus:getSetting({"INTERACTION", "SHOW_TIME_REMAINING"}, true)
		HUDInteraction.SHOW_TIME_REMAINING_OUTLINE = VHUDPlus:getSetting({"INTERACTION", "SHOW_TIME_REMAINING_OUTLINE"}, false)
