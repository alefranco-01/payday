...
elseif RequiredScript == "lib/units/weapons/akimboshotgunbase" then

	local akimbo_shotgun__update_stats_values_original = AkimboShotgunBase._update_stats_values

	function AkimboShotgunBase:_update_stats_values(...)
		akimbo_shotgun__update_stats_values_original(self, ...)
