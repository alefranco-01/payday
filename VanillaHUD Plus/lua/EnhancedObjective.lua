if PDTHHud and PDTHHud.Options and PDTHHud.Options:GetValue("HUD/ObjectivesPanel") then
	return
end
if string.lower(RequiredScript) == "lib/managers/hud/hudobjectives" and not VoidUI then
...
elseif string.lower(RequiredScript) == "lib/managers/hud/hudheisttimer" then
	...
	function HUDHeistTimer:init(hud, tweak_hud)
		...
		if VHUDPlus:getSetting({"CustomHUD", "ENABLED_ENHANCED_OBJECTIVE"}, false) and not VoidUI then
